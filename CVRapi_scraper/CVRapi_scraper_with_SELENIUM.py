...
# =============================================================================
        ...
        df.to_csv('05_014620_CVRudtræk_29.08.2020__Excel_PRODUKTION_AF_SLAGTESVIN_Virksomheder.csv', sep=';', index=False, encoding = 'utf-8-sig')
...
def save_to_csv_BUILDING_SPECIFIC():
    ...
    df.to_csv("05_P-enheder_info_CVRapi_scraping_result_for_014620_CVRudtræk_29.08.2020__Excel_PRODUKTION_AF_SLAGTESVIN_Virksomheder.csv", sep=';', index=False, encoding = 'utf-8-sig')
