...
input_file = '014610_CVRudtræk_29.08.2020__Excel_AVL_af_SMAGRISE_Virksomheder.csv'

url = 'https://cvrapi.dk/api?search='


#HERE COMES THE PROXY ROTATION
...
def cvrapi2():
    ...
    try:
        ...
        for i in (df['CVR-nummer']):
            ...
            html = requests.get(url_full, proxies=proxies, verify=False)
            peinr
...
# =============================================================================
        ...
        df.to_csv('xx_CVR_info_CVRapi_scraping_result_for_014610_CVRudtræk_29.08.2020__Excel_AVL_af_SMAGRISE_Virksomheder.csv', sep=';', index=False, encoding = 'utf-8-sig')
...
def save_to_csv_BUILDING_SPECIFIC():
    ...
    df.to_csv("xx_P-enheder_info_CVRapi_scraping_result_for_014610_CVRudtræk_29.08.2020__Excel_AVL_af_SMAGRISE_Virksomheder.csv", sep=';', index=False, encoding = 'utf-8-sig')
