...
def cvrapi2():
    ...
    try:
        df = pd.read_csv(input_file, sep = ';', nrows=200, encoding = 'utf-8-sig')
...
# =============================================================================
        ...
        df.to_csv('01_014620_CVRudtræk_29.08.2020__Excel_PRODUKTION_AF_SLAGTESVIN_Virksomheder.csv', sep=';', index=False, encoding = 'utf-8-sig')
...
def save_to_csv_BUILDING_SPECIFIC():
    ...
    df.to_csv("01_P-enheder_info_CVRapi_scraping_result_for_014620_CVRudtræk_29.08.2020__Excel_PRODUKTION_AF_SLAGTESVIN_Virksomheder.csv", sep=';', index=False, encoding = 'utf-8-sig')
